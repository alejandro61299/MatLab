...
% EXERCICE_1 MATLAB code for exercice_1.fig
...
%
%      EXERCICE_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EXERCICE_1.M with the given input arguments.
%
%      EXERCICE_1('Property','Value',...) creates a new EXERCICE_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before exercice_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to exercice_1_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 22-Nov-2018 18:17:42
...
% varargin   command line arguments to exercice_1 (see VARARGIN)
...
q_a_0 =  str2num(get(handle.edit_q_a_0,"String"));
